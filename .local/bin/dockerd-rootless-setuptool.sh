...
# curl -LO https://raw.githubusercontent.com/moby/moby/refs/tags/v27.3.1/contrib/dockerd-rootless-setuptool.sh
# chmod +x dockerd-rootless-setuptool.sh
...
install_systemd() {
	...
	INFO "To run ${SYSTEMD_UNIT} on system startup, run: \`sudo loginctl enable-linger User Name\`"
	echo
}
